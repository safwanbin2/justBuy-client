...
toast.success('Logged out successfully')
    ...
    const sellerMenu = <>
        ...
        <li className="rounded-sm">
            <Link rel="noopener noreferrer" to='/dashboard/addproducts' className="flex items-center p-2 space-x-3 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
                    <path d="M453.122,79.012a128,128,0,0,0-181.087.068l-15.511,15.7L241.142,79.114l-.1-.1a128,128,0,0,0-181.02,0l-6.91,6.91a128,128,0,0,0,0,181.019L235.485,449.314l20.595,21.578.491-.492.533.533L276.4,450.574,460.032,266.94a128.147,128.147,0,0,0,0-181.019ZM437.4,244.313,256.571,425.146,75.738,244.313a96,96,0,0,1,0-135.764l6.911-6.91a96,96,0,0,1,135.713-.051l38.093,38.787,38.274-38.736a96,96,0,0,1,135.765,0l6.91,6.909A96.11,96.11,0,0,1,437.4,244.313Z"></path>
                </svg>
                ...
                <div className="flex items-center p-2 mt-12 space-x-4 justify-self-end">
                    ...
                    <div>
                        ...
                        <span className="flex items-center space-x-1">
                            <button rel="noopener noreferrer" className="text-xs hover:underline dark:text-gray-400 disabled">View profile</button>
                        </span>
                    </div>
                </div>
            </div>
